function writeLetter() {
    document.getElementById('result').innerHTML = `“${document.getElementById('Name').value} thương nhớ, <br> <br>
    ...
    ${document.getElementById('Address').value}, ${document.getElementById('Date').value}.”`
}